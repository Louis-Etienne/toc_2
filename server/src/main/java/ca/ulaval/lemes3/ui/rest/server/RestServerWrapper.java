...
public class RestServerWrapper {
    ...
    public ServletContextHandler createContextHandler(SocketIoServerWrapper socketIoServerWrapper) {
        ...
        ResourceConfig packageConfig = new ResourceConfig().packages("ca.ulaval.lemes3.ui.rest").register(new ServerBinder())
                .register(new SocketBinder(socketIoServerWrapper.getSocketIoServer()));
